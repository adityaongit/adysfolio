Source code for [adityajindal.com](https://adityajindal.com) — a personal portfolio and blog. Built with Next.js 16, Fumadocs, and a slightly over-engineered PDF viewer.
...
NEXT_PUBLIC_BASE_URL=https://adityajindal.com
```
