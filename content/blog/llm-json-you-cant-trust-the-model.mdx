...
<RoughDiagram
  direction="LR"
  nodes={[
    { id: "a", label: "LLM Response" },
    { id: "b", label: "Layer 1: Prompt" },
    { id: "c", label: "Layer 2: Extraction" },
    { id: "d", label: "Layer 3: Zod", shape: "diamond" },
    { id: "e", label: "Return Parsed Data" },
    { id: "f", label: "Retry or Fallback" },
  ]}
  edges={[
    { from: "a", to: "b" },
    { from: "b", to: "c" },
...
<RoughDiagram
  nodes={[
    { id: "a", label: "Zod Validation Failed" },
    { id: "b", label: "Feature Type?", shape: "diamond" },
    { id: "c", label: "Graceful Fallback" },
    { id: "d", label: "Retry with Backoff" },
    { id: "c1", label: "Use Original Data" },
    { id: "c2", label: "Resume Stays Usable" },
    { id: "d1", label: "Wait 2^n seconds" },
    { id: "d2", label: "Retry Extraction" },
    { id: "d3", label: "Success?", shape: "diamond" },
    { id: "e", label: "Return Data" },
    { id: "g", label: "Log Error & Fail" },
  ]}
  edges={[
    { from: "a",  to: "b" },
